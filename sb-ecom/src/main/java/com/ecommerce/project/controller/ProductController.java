...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProductsForAdmin(
        ...
        ProductResponse productResponse = productService.getAllProductsForAdmin(pageNumber, pageSize, sortBy, sortOrder, keyword, categoryId);
        return new ResponseEntity<>(productResponse,HttpStatus.OK);
    }
    ...
    public ResponseEntity<ProductResponse> getAllProductsForSeller(
        ...
        ProductResponse productResponse = productService.getAllProductsForSeller(pageNumber, pageSize, sortBy, sortOrder, keyword, categoryId);
        return new ResponseEntity<>(productResponse,HttpStatus.OK);
    }
